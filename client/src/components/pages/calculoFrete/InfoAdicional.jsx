...
function InfoAdicional() {
    ...
    const handleSubmit = (e) => {
        ...
        // Recuperar pedidos existentes do localStorage
        ...
        // Redirecionar para a página "AulasCadastradas"
        navigate('/aulas-cadastradas');
    };
                ...
                <form className="form-correio" onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <input type="text" id="nomeRemetente" name="nomeRemetente" value={formData.nomeRemetente} onChange={handleChange} required />
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <input type="text" id="cpfCnpj" name="cpfCnpj" value={formData.cpfCnpj} onChange={handleChange} required />
                        </div>
                        <div className="col">
                    ...
                    <button type="submit" className="btn-submit">Pedir</button>
                </form>
            </div>
        </div>
    );
